...
This repo has a Docker Template ready to use. 
To transfer this to your Docker manager templates directory:

```bash
cd /boot/config/plugins/dockerMan/templates-user
curl -L -o my-checkarr.xml https://raw.githubusercontent.com/n0-h0pe/checkarr/refs/heads/master/UnraidDockerTemplate.xml
```
Then browse to your Unraid Docker tab. Click Add Container. 
Select `checkarr` from the list. The template should auto populate
some variables. Change any of these to fit your needs
ie. your appdata is in a differnt location, change 
`/mnt/user/appdata/checkarr` inside the AppData volume mapping
to whever you want your config directory.

When finished, click `Apply` and the container will start.
...
Then, in the Docker tab, click the checkarr container's **force update** option, 
then **Yes, update It!** This recreates the
